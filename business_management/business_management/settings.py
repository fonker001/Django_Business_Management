...
SECRET_KEY = 'django-insecure-j*bbqt!cg#@c&+mk#3le*+*qowca*4jceqrvwp3y%-%uo(3g$f'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['fonkertech.co.ke','www.fonkertech.co.ke','88.198.22.18']
...
LOGIN_URL = 'login'  # This is the name of your login URL
